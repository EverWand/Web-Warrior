...
/*Variable to keep track of how much something heals the player*/
let healAmount = 0;
...
/*-----------------PLAYER LEVEL UP!----------------------*/
    ...
    /*____Results Window Display____*/
        ...
        document.getElementById("hpUp")="Max Health: +" + hpInc;
        /*Displays the Max Mana Increase*/
        document.getElementById("manaUp")="Max Mana: +" + ManaInc;
        /*Displays the Strength Increase*/
        document.getElementById("strUp") = "Strength: +" + strInc;
...
function Rest(){
    ...
    if(plHealthCur==plHealthMax && plManaCur==plManaMax){
        ...
        plManaCur=plManaMax;
        /*Changes the Text for the Shop*/
        document.getElementById("ShopKeeText").innerHTML= "<br>";
        if (sfxOn == true){
